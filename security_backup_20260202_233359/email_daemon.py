...
class EmailDaemon:
    ...
    def process_message(self, message: Dict) -> str:
        """Process a message through the agent backend."""
...
"""
        ...
        try:
            # Use agent's run() method - it handles backend selection
            ...
            return f"Error processing your message. The agent encountered an issue: {e}"
